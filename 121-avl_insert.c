...
/**
 * r_insert_node - a function that inserts a value in an AVL Tree
 * @tree: type double pointer of root node of the AVL tree.
 * @parent: parent node.
 * @new: double pointer to left or right insertion.
 * @nval: insertion value of the AVL.
 * Return: pointer to the new root value
 */
 ...
 * @tree: doube pointer to the root node of the AVL tree.
