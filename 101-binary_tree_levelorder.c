...
/**
 * binary_tree_levelorder - a function that traverst a
 * binary tree using level-order traverse
 *
 * @tree: pointer to a tree to traverse
...
/**
 * btlo_helper - a function that goes through a binary
 ...
 *
 * @tree: pointer to a tree to measure the height of
 *
 * Return: height of the tree in int
 */
